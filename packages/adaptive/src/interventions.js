...
function getInterventions(errorTag, module) {
    var r = C;
    if (errorTag)
        r = r.filter(function (i) { return i.errorTag === errorTag; });
    if (module)
        r = r.filter(function (i) { return i.module === module; });
    return __spreadArray([], r, true);
}
function getAllModules() { return __spreadArray([], new Set(C.map(function (i) { return i.module; })), true); }
